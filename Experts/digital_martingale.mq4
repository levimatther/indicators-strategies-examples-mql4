...
#define EAName      "Digital Martingale"
...
extern string       INFO45                          = "Digital Martingale";
...
extern int          ManualGMToffset                 = 2;         // Set your broker's GMT Offset here in case AutoGMT fails

extern bool         NoHedge                         = true;
extern bool         StrictNoHedge                   = true;  

extern string       __                              = "Indicators settings";
extern int          FilterType                      = 1; 
extern int          FilterType2                     = 2; 
extern int          Price                           = PRICE_CLOSE;
extern int          Length                          = 5;
extern double       Phase                           = 0;
extern int          LengthForBands                  = 52; 
extern int          dftf                            = 0;
extern int          dftf2                           = 240;
...
extern int          MaxTrades                       = 6;           // Maximum number of orders to open
...
extern int          MagicNumber                     = 41955;        // Primary Magic number for all orders placed
...
int CheckEntrySignal()
{
  int myOrderType = 3;
    ...
    if (Strategy == 1) 
  {
    if (Var1 < Var2 && Var3 < Var4 && Var5 < Var6 && Bid >= r1 && Bid <= r3) 
      myOrderType = 1; // signal a sell
    if (Var1 > Var2 && Var3 > Var4 && Var5 > Var6 && Bid <= s1 && Bid >= s3) 
...
void PrepareIndicators()
{
   ...
   Var1  = iCustom(NULL,dftf, "Dfs separate for ea",FilterType,Price,Length,Phase,LengthForBands,4,1);
   Var2  = iCustom(NULL,dftf, "Dfs separate for ea",FilterType,Price,Length,Phase,LengthForBands,4,2);
   Var3  = iCustom(NULL,dftf2,"Dfs separate for ea",FilterType,Price,Length,Phase,LengthForBands,4,1);
   Var4  = iCustom(NULL,dftf2,"Dfs separate for ea",FilterType,Price,Length,Phase,LengthForBands,4,2);
   Var5  = iCustom(NULL,dftf, "Dfs separate for ea",FilterType2,Price,Length,Phase,LengthForBands,4,1);
   Var6  = iCustom(NULL,dftf, "Dfs separate for ea",FilterType2,Price,Length,Phase,LengthForBands,4,2);
